...
func (s *ModularCompulationUnitContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case JavaParserVisitor:
		return t.VisitModularCompulationUnit(s)
...
func (s *AnnotationFieldValuesContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case JavaParserVisitor:
		return t.VisitAnnotationFieldValues(s)
...
func (s *AnnotationFieldValueContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case JavaParserVisitor:
		return t.VisitAnnotationFieldValue(s)
...
func (p *JavaParser) AnnotationFieldValue() (localctx IAnnotationFieldValueContext) {
	...
	case 1:
		...
		if !(p.IsNotIdentifierAssign()) {
			p.SetError(antlr.NewFailedPredicateException(p, " p.IsNotIdentifierAssign() ", ""))
			goto errorExit
		}
		{
			p.SetState(873)
...
func (p *JavaParser) RecordComponentList() (localctx IRecordComponentListContext) {
	...
	if !(p.DoLastRecordComponent()) {
		p.SetError(antlr.NewFailedPredicateException(p, " p.DoLastRecordComponent() ", ""))
		goto errorExit
	}
...
func (s *ComponentPatternListContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case JavaParserVisitor:
		return t.VisitComponentPatternList(s)
...
func (s *ComponentPatternContext) Accept(visitor antlr.ParseTreeVisitor) interface{} {
	switch t := visitor.(type) {
	case JavaParserVisitor:
		return t.VisitComponentPattern(s)
