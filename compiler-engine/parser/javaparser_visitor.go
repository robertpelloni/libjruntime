...
type JavaParserVisitor interface {
	...
	VisitModularCompulationUnit(ctx *ModularCompulationUnitContext) interface{}
	...
	VisitAnnotationFieldValues(ctx *AnnotationFieldValuesContext) interface{}

	// Visit a parse tree produced by JavaParser#annotationFieldValue.
	VisitAnnotationFieldValue(ctx *AnnotationFieldValueContext) interface{}
	...
	VisitComponentPatternList(ctx *ComponentPatternListContext) interface{}

	// Visit a parse tree produced by JavaParser#componentPattern.
	VisitComponentPattern(ctx *ComponentPatternContext) interface{}
